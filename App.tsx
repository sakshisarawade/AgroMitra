...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-green-50 pb-12 font-sans selection:bg-green-200 flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className={`lg:col-span-${status === AnalysisStatus.SUCCESS ? '5' : '12'} transition-all duration-500 ease-in-out`}>
                  ...
                  <div className="relative aspect-square w-full overflow-hidden rounded-lg bg-green-50">
                    ...
                    />
                     ...
                     {status === AnalysisStatus.ANALYZING && (
                      <div className="absolute inset-0 bg-green-900/20 backdrop-blur-[2px] z-10 flex flex-col items-center justify-center" role="status">
              ...
              {status === AnalysisStatus.ERROR && (
                 <div className="mt-4 p-4 bg-red-50 text-red-700 rounded-lg border border-red-200 flex items-start space-x-3" role="alert">
      ...
      <footer className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-12 py-6 border-t border-green-200 text-center text-sm text-green-700/80">
        <p>&copy; {new Date().getFullYear()} AgroMitra. All Rights Reserved.</p>
        <p className="mt-1">
          This is a demonstration application. Do not base real-world agricultural decisions solely on its analysis. Always consult with a qualified professional.
        </p>
      </footer>
